...
@section('content')
                                ...
                                <tr>
                                    ...
                                    @if (Auth::user()->role == 'superadmin' || Auth::user()->role == 'admin')
                                        <td class="d-flex flex-column flex-sm-row gap-2">
                                            ...
                                            <!-- Tombol Hapus -->
                                            <a href="{{ route('area.destroy', $datas->id) }}"
    ...
    @include('superadmin.area.add')
    @include('superadmin.area.edit')
    @push('style')
        {{-- datatable --}}
    ...
    @push('scripts')
        ...
        <script>
            ...
            function printPDF() {
                ...
                let title = "Data Area E-REPORTING PT SOLAS LANGGENG SEJAHTERA";
            ...
            function exportExcel() {
                ...
                XLSX.utils.book_append_sheet(wb, ws, "Data Area");

                // Menyimpan file Excel
                XLSX.writeFile(wb, "Data_Area.xlsx");
