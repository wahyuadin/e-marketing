...
@section('content')
        ...
        <div class="card w-100">
            <div class="card-body">
                ...
                <div class="table-responsive mt-3">
                    <div class="mt-3 mb-4">
                        @if (Auth::user()->role == 'superadmin' || Auth::user()->role == 'admin_pusat')
                        @endif
    ...
    @include('superadmin.dokter.edit')
    ...
    @push('scripts')
        ...
        <script>
            ...
            function printPDF() {
                ...
                let title = "DATA DOKTER E-REPORTING PT SOLAS LANGGENG SEJAHTERA";
            ...
            function exportExcel() {
                ...
                XLSX.utils.book_append_sheet(wb, ws, "Data Dokter");

                // Menyimpan file Excel
                XLSX.writeFile(wb, "Data_Dokter.xlsx");
