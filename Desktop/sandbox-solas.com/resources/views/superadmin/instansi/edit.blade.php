    ...
    <div class="modal fade" id="editData{{ $datas->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form action="{{ route('instansi.update', $datas->id) }}" method="POST" class="needs-validation"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Data Instansi ||
                            {{ config('app.name') }}
                        </h1>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="instansi" id="instansi" required
                                        value="{{ old('instansi', $datas->instansi) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="kategori">
                                        ...
                                        <option value="apotek" {{ $datas->kategori == 'apotek' ? 'selected' : '' }}>
                                            Apotek</option>
                                        <option value="rs" {{ $datas->kategori == 'rs' ? 'selected' : '' }}>Rumah
                                            Sakit</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="no_hp" name="no_hp" class="form-control"
                                        value="{{ old('no_hp', $datas->no_hp) }}" placeholder="Masukan Alamat No Telp">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
