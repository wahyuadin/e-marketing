<div class="modal fade" id="addData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="{{ route('instansi-data.store') }}" method="POST" class="needs-validation" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="instansi" id="instansi" required
                                    value="{{ old('instansi') }}" placeholder="Masukan Nama Instansi">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
