...
@section('content')
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6 col-md-8">
                        <h5 class="card-title">Data Instansi [<b>{{ $data->instansi }}</b>]</h5>
                    </div>
                </div>
                        ...
                        <thead>
                            ...
                            @foreach ($data->instansiDetail as $datas)
                                <tr>
                                    ...
                                    <td>{{ $datas->dokter->dokter ?? '' }} - {{ $datas->dokter->spesialis->spesialis ?? '' }}</td>
                                    <td>
                                        <div class="d-flex flex-column flex-sm-row gap-2">
                                            ...
                                            <a href="{{ route('instansi-detail.destroy', $datas->id) }}" class="btn btn-danger btn-sm bx bx-trash" data-confirm-delete="true"></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
    ...
    @include('admin.instansi.detail.add')
    @include('admin.instansi.detail.edit')
    @push('style')
        {{-- datatable --}}
