...
<div class="modal fade" id="ModalEdit{{ $datas->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="{{ route('spesialis.update', $datas->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="spesialis" id="spesialis" required
                            value="{{ old('spesialis', $datas->spesialis) }}" placeholder="Masukan Nama Spesialis">
                    </div>
                </div>
