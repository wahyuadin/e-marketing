...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const addpw = document.getElementById('addpw');
        ...
        if (addpw) {
            addpw.addEventListener('click', function() {
    ...
    document.getElementById('addData').addEventListener('shown.bs.modal', function() {
        const addpw = document.getElementById('addpw');
        if (addpw) {
            addpw.addEventListener('click', function() {
                const passwordInput = document.getElementById('addpwd');
