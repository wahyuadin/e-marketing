      ...
      <div class="w-px-400 mx-auto mt-12 pt-5">
        ...
        <form class="mb-6" action="{{ url('/') }}" method="POST">
          ...
          <div class="mb-6">
            ...
            <input type="number" class="form-control" name="nip" placeholder="Masukan NIP"  value="{{ $rememberDeviceDecoded ? $rememberDeviceDecoded->nip : '11223344' }}" autofocus>
            @if ($errors->has('nip'))
...
@endif
          ...
          <div class="mb-6 form-password-toggle">
            ...
            <div class="input-group input-group-merge">
              <input type="password" class="form-control" name="password" value="{{ $rememberDeviceDecoded ? $rememberDeviceDecoded->password : 'password' }}" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
